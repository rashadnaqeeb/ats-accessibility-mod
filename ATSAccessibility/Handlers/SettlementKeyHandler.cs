...
namespace ATSAccessibility.Handlers {
	...
	public class SettlementKeyHandler: IKeyHandler, IHelpProvider {
		...
		private static readonly List<HelpEntry> _helpEntries = new List<HelpEntry> {
			new HelpEntry("Ctrl+Arrows", Strings.Get("handler.settlement_key.help.skip_to_change")),
			new HelpEntry("K", Strings.Get("handler.settlement_key.help.announce_position")),
			new HelpEntry("Alt+K", Strings.Get("handler.settlement_key.help.toggle_coords")),
			new HelpEntry("I", Strings.Get("handler.settlement_key.help.tile_info")),
			new HelpEntry("Space", Strings.Get("handler.settlement_key.help.pause")),
			new HelpEntry("1-4", Strings.Get("handler.settlement_key.help.game_speed")),
			new HelpEntry("S", Strings.Get("handler.settlement_key.help.quick_summary")),
			new HelpEntry("V", Strings.Get("handler.settlement_key.help.species_resolve")),
			new HelpEntry("T", Strings.Get("handler.settlement_key.help.time_summary")),
			new HelpEntry("Shift+T", Strings.Get("handler.settlement_key.help.trends_popup")),
			new HelpEntry("O", Strings.Get("handler.settlement_key.help.tracked_orders")),
			new HelpEntry("M", Strings.Get("handler.settlement_key.help.move_building")),
			new HelpEntry("R", Strings.Get("handler.settlement_key.help.rotate_building")),
			new HelpEntry("Shift+R", Strings.Get("handler.settlement_key.help.rotate_ccw")),
			new HelpEntry("Shift+Space", Strings.Get("handler.settlement_key.help.destroy_or_remove")),
			new HelpEntry("E", Strings.Get("handler.settlement_key.help.entrance_info")),
			new HelpEntry("W", Strings.Get("handler.settlement_key.help.worker_summary")),
			new HelpEntry("+/-", Strings.Get("handler.settlement_key.help.cycle_race_priority")),
			new HelpEntry("Shift+/-", Strings.Get("handler.settlement_key.help.add_remove_worker")),
			new HelpEntry("Period/Comma", Strings.Get("handler.settlement_key.help.cycle_worker_bldgs")),
			new HelpEntry("Shift+Period/Comma", Strings.Get("handler.settlement_key.help.cycle_worker_cat")),
			new HelpEntry("Backspace", Strings.Get("handler.settlement_key.help.toggle_tree_mark")),
			new HelpEntry("D", Strings.Get("handler.settlement_key.help.range_info")),
			new HelpEntry("Alt+D", Strings.Get("handler.settlement_key.help.blight_info")),
			new HelpEntry("P", Strings.Get("handler.settlement_key.help.rainpunk_info")),
			new HelpEntry("Shift+P", Strings.Get("handler.settlement_key.help.stop_engines")),
			new HelpEntry("Shift+B", Strings.Get("handler.settlement_key.help.set_bookmark")),
			new HelpEntry("B", Strings.Get("handler.settlement_key.help.jump_bookmark")),
			new HelpEntry("Alt+B", Strings.Get("handler.settlement_key.help.dir_bookmark")),
			new HelpEntry("Ctrl+0-9", Strings.Get("handler.settlement_key.help.set_n_bookmark")),
			new HelpEntry("Shift+0-9", Strings.Get("handler.settlement_key.help.jump_n_bookmark")),
			new HelpEntry("Alt+0-9", Strings.Get("handler.settlement_key.help.dir_n_bookmark")),
			new HelpEntry("Alt+H", Strings.Get("handler.settlement_key.help.reset_hearth")),
			new HelpEntry("Shift+N", Strings.Get("handler.settlement_key.help.jump_latest_event")),
			new HelpEntry("Alt+N", Strings.Get("handler.settlement_key.help.announce_history")),
			new HelpEntry("Ctrl+PageUp/Down", Strings.Get("handler.settlement_key.help.scanner_category")),
			new HelpEntry("Shift+PageUp/Down", Strings.Get("handler.settlement_key.help.scanner_subcategory")),
			new HelpEntry("PageUp/Down", Strings.Get("handler.settlement_key.help.scanner_group")),
			new HelpEntry("Alt+PageUp/Down", Strings.Get("handler.settlement_key.help.scanner_item")),
			new HelpEntry("Home", Strings.Get("handler.settlement_key.help.scanner_jump")),
			new HelpEntry("Alt+Home", Strings.Get("handler.settlement_key.help.scanner_automove")),
			new HelpEntry("End", Strings.Get("handler.settlement_key.help.scanner_distance")),
			new HelpEntry("Alt+I", Strings.Get("handler.settlement_key.help.scanner_item_info")),
			new HelpEntry("Ctrl+F", Strings.Get("handler.settlement_key.help.scanner_search")),
			new HelpEntry("F1", Strings.Get("handler.settlement_key.help.info_panels")),
			new HelpEntry("F2", Strings.Get("handler.settlement_key.help.quick_menu")),
			new HelpEntry("F3", Strings.Get("handler.settlement_key.help.rewards_panel")),
			new HelpEntry("Tab", Strings.Get("handler.settlement_key.help.building_menu")),
			new HelpEntry("Shift+S", Strings.Get("handler.settlement_key.help.stats_panel")),
			new HelpEntry("Shift+V", Strings.Get("handler.settlement_key.help.villagers_panel")),
			new HelpEntry("Shift+W", Strings.Get("handler.settlement_key.help.workers_panel")),
			new HelpEntry("Shift+M", Strings.Get("handler.settlement_key.help.modifiers_panel")),
			new HelpEntry("Shift+O", Strings.Get("handler.settlement_key.help.orders_popup")),
		};
